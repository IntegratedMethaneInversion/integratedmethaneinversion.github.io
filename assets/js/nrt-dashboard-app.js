/* =========================================================
   ...
   - Show weekly regional summary charts
...
async function fetchManifest() {
  console.log(`Using grid manifest path: ${GRID_MANIFEST_PATH}`);
...
function currentSummaryUnitLabel() {
  return state.el.unitSelect.value === "Gg" ? "Gg/week" : "Tg/week";
}
...
function lineModeLabel() {
  return state.lineShowMovingAverage ? "Centered 3-week moving average" : "Weekly totals";
}
...
function makeLineCsvRows() {
  ...
  const rows = [
    ...
    ["moving_average_mode", "centered_3_week"],
